...
var Filter = /** @class */ (function () {
    ...
    Filter.prototype.closeType = function () {
        ...
        typeHeader.textContent = "\u041B\u044E\u0431\u043E\u0439" /* PossibleInputValues.any */;
        var typeInput = document.getElementById("typeInput");
        if (typeInput instanceof HTMLInputElement) {
            typeInput.value = "\u041B\u044E\u0431\u043E\u0439" /* PossibleInputValues.any */;
        }
    };
    Filter.prototype.filterValues = function () {
        ...
        if (maxPriceInput instanceof HTMLInputElement &&
            ...
            var typeValue_1 = typeInput.value;
            ...
            if (!typeValue_1 || typeValue_1 === "\u041B\u044E\u0431\u043E\u0439" /* PossibleInputValues.any */) {
                typeValue_1 = "";
            }
            if (!countryValue_1) {
                countryValue_1 = "";
            ...
            //   );
            // });
            var filteredCars = arrayCars
                .filter(function (car) { return car.price <= maxPriceValue_1 && car.price >= minPriceValue_1; })
                .filter(function (car) { return !typeValue_1 || car.type === typeValue_1; })
                .filter(function (car) { return !manufactures_1.length || manufactures_1.includes(car.manufacturer); })
                .filter(function (car) { return !countryValue_1 || car.country === countryValue_1; })
                .filter(function (car) { return !transmissions_1.length || transmissions_1.includes(car.transmission); })
                .filter(function (car) { return !ads_1.length || ads_1.includes(car.ad); });
