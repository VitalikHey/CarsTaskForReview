  ...
  Filter.prototype.filterValues = function () {
    ...
    if (
      ...
      var filteredCars = arrayCars
        .filter(function (car) {
          return car.price <= maxPriceValue_1 && car.price >= minPriceValue_1;
        })
        .filter(function (car) {
          return !typeValue_1 || car.type === typeValue_1;
        })
        .filter(function (car) {
          return (
        ...
        .filter(function (car) {
          return !countryValue_1 || car.country === countryValue_1;
        })
        .filter(function (car) {
          return (
        ...
        .filter(function (car) {
          return !ads_1.length || ads_1.includes(car.ad);
        });
